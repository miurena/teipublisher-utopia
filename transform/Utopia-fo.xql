            ...
            return
                    ...
                    case element(div) return
                        if (@type="title-page") then
                            fo:block($config, ., ("tei-div", css:map-rend-to-class(.)), .)
                        else
                    ...
                    case element(lem) return
                        fo:alternate($config, ., ("tei-lem", css:map-rend-to-class(.)), ., ., concat("1790: ", string(following-sibling::rdg[@wit="1790"]), " 1805: ", string(following-sibling::rdg[@wit="1805"])))
                    case element(rdg) return
                        fo:omit($config, ., ("tei-rdg", css:map-rend-to-class(.)), .)
                    case element() return
